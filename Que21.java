...
-given below keyword which you get from the Excel and check into your website
...
public class Que21 {
	...
	//	for (int i = 0; i < data.length; i++) {
		...
		if (keyword.equalsIgnoreCase("open browser")) {
			...
			driver.findElement(By.xpath("//input[@placeholder='E mail']")).sendKeys("rahul.sanghavi.mca@gmail.com");
			Thread.sleep(2000);
		}else if (keyword.equalsIgnoreCase("enter password")) {
			driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("rahul12345");
			Thread.sleep(2000);
